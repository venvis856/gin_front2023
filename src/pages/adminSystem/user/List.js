...
import {listApi, deleteApi} from "../../../server/user";
...
function List(props) {
    ...
    const columns = [
        ...
        {title: '名字', dataIndex: 'username', width: 80, align: 'center'},
        {
    ...
    const [search, setSearch] = useState({
        ...
        username: {operator: 'like', value: '', type: 'both'},
    ...
    return (
        <React.Fragment>
            <div className="search_body">
                ...
                <div className="search_item">
                    <div className="search_item_font">用户名:</div>
                    <Input className="search_item_input" allowClear placeholder="请输入用户名"
